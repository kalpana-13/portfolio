          ...
          <div className="projects-grid">
            <div className="project-card slide-up">
              <div className="project-image">
                <img src="src\pages\TextUtil.png" alt="Notes.Me Project" />
              </div>
              <h3>TextUtils</h3>
            ...
            <div className="project-card slide-up">
              <div className="project-image">
                <img src="src\pages\Quiz.png" alt="Quiz App Project" />
              </div>
              <h3>Quiz App</h3>
            ...
            <div className="project-card slide-up">
              <div className="project-image">
                <img src="src\pages\Ecommerce.png" alt="Ecommerce Website Project" />
              </div>
